      ...
      <form class='Visitor-Form' action="" method='post'>
        <div class="Visitor-Form-div-1">
          ...
          <div class="Visitor-Form-Phone">
            ...
            <input type="number" name="phone_number" value='<?php echo $phone_number ?>' min='0'
        ...
        <div class="Visitor-Form-div-4">
          <div class="Visitor-Form-Address">
            ...
            <textarea name="address" placeholder='Permanant Residential Address'
              autocomplete='off'><?php echo $address ?></textarea>
            <span>
              <?php echo $addressErr ?>
            </span>
          </div>
          ...
          <div class="Visitor-Form-pov">
            ...
            <textarea name="purpose_of_visit" id='purpose_of_visit' placeholder='Purpose of visit'
              autocomplete='off'><?php echo $purpose_of_visit ?></textarea>
            <span>
              <?php echo $povErr ?>
            </span>
          </div>
        ...
        <div class="Visitor-Form-div-5">
          <div class="Visitor-Form-Upload">
            <p class='js-modal-trigger button is-dark' data-target="picture-Model">Capture your image</p>
            <span>
